    ...
    <section class="login">
        <div class="container">
            ...
            <style type="text/css">
                ...
                .st12{fill:none;stroke:#000000;stroke-width:1.0746;stroke-linecap:round;stroke-miterlimit:10;}
                .st13{fill:none;stroke:#000000;stroke-linecap:round;stroke-miterlimit:10;}
                    ...
                    h654.6V551.9C817,552.9,797.6,551.3,794.5,543.5z"/>
                        ...
                        <g id="Shadows">
                            <pattern  id="SVGID_1_" xlink:href="#New_Pattern" patternTransform="matrix(0.3 0 0 0.3 -5370.8037 -4697.1909)">
                            </pattern>
                            <path class="st5" d="M732.7,796c0,5.7-38.2,106.6-94.1,106.6c45.8,0,141.5,0,141.5,0V796H732.7"/>
                            <pattern  id="SVGID_2_" xlink:href="#New_Pattern" patternTransform="matrix(0.3 0 0 0.3 -5370.8037 -4697.1909)">
                            </pattern>
                            <path class="st6" d="M135.4,819.7c0,3.5-42.4,90.2-57.6,90.2c17.2,0,62.9,0,62.9,0l23-90.4h-28.2"/>
                            <pattern  id="SVGID_3_" xlink:href="#New_Pattern" patternTransform="matrix(0.3 0 0 0.3 -5371.3267 -4690.8672)">
                            </pattern>
                    ...
                    l-3.9,2.8l-3.7,3.1l-3.9,3.8l-4,4.4l-5.6,6.5"/>
                            <pattern  id="SVGID_4_" xlink:href="#New_Pattern" patternTransform="matrix(0.3 0 0 0.3 -5371.3267 -4690.8672)">
                            </pattern>
                ...
                <div class="col-lg-6 center">
                    <div class="w-80">
                        <div class="form-login">
                            <h2>Авторизация</h2>
                            <form action="{{url($lang,'signup')}}" method="post" id="signup">
                                <input type="text" placeholder="Email" name="email">
                                <a href="{{url($lang,'forget-password')}}" class='light-url'>забыл пароль ?</a>
                                ...
                                <div class="center"><button class='btn-go' type="submit" onclick="saveForm(this)" data-form-id="signup">Войти</button>
                                </div>
                                <h6 class='mt-3'>Авторизация через соц-сети</h6>
                        ...
                        <div class="back-or-go">
                            <a href="{{url($lang)}}">Вернуться на сайт</a>
                            <a href="{{url($lang,'register')}}">Зарегистрироваться</a>
                        </div>
                    </div>
                </div>
            </div>
