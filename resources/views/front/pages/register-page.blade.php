                    ...
                    <div class="w-80">
                        <div class="form-login">
                            ...
                            <form action="{{url($lang,'regin')}}" id="register" method="post">
                                ...
                                <div class="center"><button class='btn-go' type="submit" onclick="saveForm(this)" data-form-id="register">Зарегистрироваться</button>
                                </div>
                                <h6 class='mt-3'>Зарегистрироваться через сети</h6>
