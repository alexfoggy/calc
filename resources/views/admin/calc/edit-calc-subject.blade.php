...
@section('content')
    ...
    <div class="form-content">
        ...
        <div class="form-page">
            ...
            <div class="form-body">
                <form class="form" method="POST" action="{{ urlForLanguage($lang, 'saveCalcSubject/'.$calc_id->id.'/'.$lang_to_edit) }}" id="edit-form" data-parent-url="{{--{{$url_for_active_elem}}--}}" enctype="multipart/form-data">
                    ...
                    <div class="fields-row ckeditor hide">
                        ...
                        <div class="input-wrap">
                            <textarea name="body" id="body" data-type="ckeditor">
                                {{$calc_with_lang->body ?? ''}}
                            </textarea>
                        </div>
                    </div>
