...
@section('content')
    ...
    <div class="form-content">
        ...
        <div class="form-page">
            ...
            <div class="form-body">
                <form class="form" method="POST" action="{{ urlForLanguage($lang, 'saveCalcSubject/0/'.$lang_id) }}" id="edit-form" data-parent-url="{{--{{$url_for_active_elem}}--}}" enctype="multipart/form-data">
...
{{--                    </div>--}}
                    ...
                    <div class="fields-row">
                        ...
                        <div class="input-wrap">
                            <input name="meta_title" id="meta_title" value="">
                        </div>
                    </div>
                    <div class="fields-row">
                        <div class="label-wrap">
                        ...
                        <div class="input-wrap">
                            <input name="meta_keywords" id="meta_keywords" value="">
                        </div>
                    </div>
                    <div class="fields-row">
                        <div class="label-wrap">
                        ...
                        <div class="input-wrap">
                            <input name="meta_description" id="meta_description" value="">
                        </div>
                    </div>
