                    ...
                    <div class="fields-row">
                        ...
                        <div class="d-flex between">
                            <div class="input-wrap w-20">
                                <input name="formula[{{$one_formula->id}}]" id="" value="{{$one_formula->formula}}" placeholder="Формула">
                            </div>
                            <div class="input-wrap w-20 ">
                                <input name="formula_dime[{{$one_formula->id}}]" id="" value="{{$one_formula->itemByLang->dime ?? '' }}" placeholder="Текст перед выводом ">
                            </div>
                            <div class="input-wrap w-20 ">
                                <input name="formula_dimetext[{{$one_formula->id}}]" id="" value="{{$one_formula->itemByLang->dime_text ?? '' }}" placeholder="Единицы измерения">
                            </div>
                            <div class="input-wrap w-20 ">
                                <input name="formula_name[{{$one_formula->id}}]" id="" value="{{$one_formula->itemByLang->name ?? '' }}" placeholder="Название формулы">
                            </div>
                            <div class="input-wrap w-20 ">
                            ...
                            <div class="delete-row-calc delete-row-calc-formula" data-delete="{{$one_formula->id}}">
                                ...
                                <div class="d-flex between">
                                    ...
                                    <div class="input-wrap w-20 ">
                                        <input name="formula_dimetext[]" id="" value="" placeholder="Единицы измерения">
                                    </div>
                                    <div class="input-wrap w-20 ">
                                        <input name="formula_name[]" id="" value="" placeholder="Название формулы">
                                    </div>
...
{{--                        </div>--}}
                    ...
                    <div class="fields-row">
                        ...
                        <div class="d-flex between">
                        <div class="input-wrap w-20">
                            <input name="p[{{$one_var->id}}]" id="" value="{{$one_var->itemByLang->name ?? ''}}" placeholder="Название">
                        </div>
                        <div class="input-wrap w-20 ">
                            <input name="v[{{$one_var->id}}]" id="" value="{{$one_var->variable ?? ''}}" placeholder="Переменная из формулы">
                        </div>
                            <div class="input-wrap w-20 ">
                                <input name="v_before[{{$one_var->id}}]" id="" value="{{$one_var->itemByLang->before_text ?? ''}}" placeholder="текст перед поля">
                            </div>
                            <div class="input-wrap w-20 ">
                                <input name="v_after[{{$one_var->id}}]" id="" value="{{$one_var->itemByLang->after_text ?? ''}}" placeholder="текст после поля">
                            </div>
