...
@section('content')
    ...
    <div class="form-content">
        ...
        <div class="form-page">
            ...
            <div class="form-body">
                <form class="form" method="POST" action="{{ urlForLanguage($lang, 'savemenu') }}" id="add-form" enctype="multipart/form-data">
                    ...
                    <div class="fields-row">
                        ...
                        @include('admin.newUploadPhotos', ['modules_name' => $modules_name, 'multiple' => true, 'one_image' => null, 'images' => []])
                    </div>
                    @if( !is_null($curr_page_menu_id) && $curr_page_menu_id->alias == 'consiliul-administrativ')
                    <div class="fields-row">
                        <div class="label-wrap">
                            <label for="h1_title">Show on top of page</label>
                        </div>
                        <div class="input-wrap">
                            <input type="checkbox" id="page_top" name="page_top">
                        </div>
